...
3. A Virtual Network, A public IP, NSG, a NIC and a VM will also be created. 
4. We will be using three files (main.tf, variables.tf, terraform.tfvars) to deploy our resources 
---
