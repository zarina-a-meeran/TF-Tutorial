...
In this tutorial you will create a resource group called "myTFResourceGroup" to hold all of your resources. It will be created in the eastUS zone, where you will apply a tag called "DevOps". 
